...
export const metadata: Metadata = {
  title: 'Business Review Scan — Automated Google Review Scanner & Threat Detection | Reach Them AI',
  description:
    'Scan every Google review for your business automatically. Our AI-powered scanner detects fake reviews, spam, harassment, and 8 other policy violations — then generates evidence-based removal strategies. Free scan available.',
  keywords: [
  ...
  openGraph: {
    title: 'Business Review Scan — Automated Google Review Scanner & Threat Detection',
    description:
  ...
  twitter: {
    ...
    title: 'Business Review Scan — Automated Google Review Scanner',
    description:
...
const softwareJsonLd = {
  ...
  name: 'Business Review Scan — Google Review Scanner',
...
export default async function BusinessReviewScanPage() {
  ...
  return (
    <>
      <Script
        id="business-review-scan-faq-jsonld"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqJsonLdWithPrices) }}
      />
      <Script
        id="business-review-scan-software-jsonld"
        type="application/ld+json"
      ...
      <div className="min-h-screen bg-white dark:bg-slate-900">
        ...
        <main>
          <HeroSection
            headlineLine1="Analyze Your Reviews Instantly"
            headlineLine2="See Which Ones Are Hurting Your Business"
            headlineLine3="& Remove All Bad Reviews"
          />
