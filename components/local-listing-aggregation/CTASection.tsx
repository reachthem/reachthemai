  ...
  return (
    <section className="py-16 bg-gradient-to-r from-[#0A2540] to-[#0074D9] text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-2xl font-bold mb-4">Ready to fix your listings and get found?</h2>
        <p className="text-slate-100 mb-6">Start with our platform or let our team handle everything for you.</p>
