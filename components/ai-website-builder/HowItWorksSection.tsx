...
const steps = [["Share the business details", "Provide your services, location, brand voice, and conversion goals."], ["Generate the site", "Create a custom website structure and content with AI in minutes."], ["Launch and optimize", "Publish the site and refine it as rankings and customer behavior evolve."]];
