...
const items = [["Real-time analysis", "Correlate rankings with reviews, listings, and mentions so you can see what actually drives momentum."], ["Smart recommendations", "Get suggestions for content, citations, and review strategy tailored to each location."], ["Plain-English reporting", "Share clear summaries with owners and teams without needing advanced SEO expertise."]];
