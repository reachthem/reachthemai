...
const steps = [["Audit your profile", "Scan the current profile for completeness, quality, and missing opportunities."], ["Create and publish updates", "Generate posts, Q&A answers, and service catalog improvements with AI assistance."], ["Track the lift", "Measure how the updates impact rankings, engagement, and calls."]];
