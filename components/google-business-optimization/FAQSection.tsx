const faqs = [["What does the module optimize?", "It improves profile completeness, post quality, Q&A responses, and service catalog details for Google Business profiles."], ["Is it only for Google?", "The module is focused on Google Business Profile performance, but it ties into the broader local SEO system."]];
