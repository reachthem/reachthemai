...
const steps = [["Plan your content", "Build a monthly calendar around offers, events, and local awareness themes."], ["Generate and publish", "Create social copy and publish it on a schedule that matches your audience."], ["Improve over time", "Track results and adjust your content strategy based on what performs."]];
