import { ClipboardList, Brain, CheckCircle2, LayoutDashboard } from 'lucide-react';
...
const steps = [
  {
    ...
    description:
      'Paste the review text, the URL, and the platform name. Takes less than 2 minutes.',
    detail: 'No technical skills needed',
  ...
  },
  {
    ...
    title: 'AI Analyzes',
    description:
      'Our AI scans the review for policy violations, fake reviewer signals, and the strongest legal grounds for removal — specific to that platform.',
  ...
  },
  {
    ...
    description:
      'Get a clear, step-by-step action plan tailored to the platform\'s specific reporting and flagging process — plus a confidence score for your case.',
    detail: 'Platform-specific guidance',
  ...
  },
  {
    ...
    description:
      'Monitor all your active removal cases in the dashboard. Follow up with AI chat if you have questions, and update status as each case progresses.',
    detail: 'All cases in one place',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-slate-900 dark:text-white">
            From Review to Action Plan in Minutes
          </h2>
          <p className="mt-4 text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            No expertise required. Submit your review and let AI do the heavy lifting.
          </p>
        </div>
