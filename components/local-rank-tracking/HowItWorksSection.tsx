...
const steps = [["Set your target locations", "Choose the neighborhoods, ZIP codes, and services you want to track."], ["Monitor visibility", "Watch Local Pack, Maps, organic rankings, and AI answer presence in one place."], ["Act on insight", "Use AI recommendations to improve rankings and protect your local presence."]];
