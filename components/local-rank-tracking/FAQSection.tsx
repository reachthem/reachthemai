const faqs = [["What can I track?", "You can monitor Google Maps, Local Pack, organic search, and AI answer visibility for each location."], ["Can I compare competitors?", "Yes. The dashboard makes it easy to compare your visibility against local competitors in the same area."]];
