const faqs = [["Can it build a full website?", "Yes. It can produce a complete, launch-ready site with core pages and conversion-focused content."], ["Does it support local SEO?", "Yes. Local SEO structure, schema, and location-specific content are built into the experience."]];
